...
#ifndef ROBOTY_AUTONOMICZNE_NOWOCZESNE_SENSORY_EDITED_LCCP_SEGMENTATION_H
#define ROBOTY_AUTONOMICZNE_NOWOCZESNE_SENSORY_EDITED_LCCP_SEGMENTATION_H
    ...
    public:
        ...
        getSVAdjacencyList (SupervoxelAdjacencyList& adjacency_list_arg) const
        {
            ...
            else
            {
                ...
                adjacency_list_arg = pcl_edited::LCCPSegmentation<PointT>::SupervoxelAdjacencyList ();
            }
        }
...
#endif //ROBOTY_AUTONOMICZNE_NOWOCZESNE_SENSORY_EDITED_LCCP_SEGMENTATION_H
